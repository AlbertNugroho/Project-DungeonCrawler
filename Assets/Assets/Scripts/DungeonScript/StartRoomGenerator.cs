...
public class StartRoomGenerator : MonoBehaviour
{
    ...
    public static HashSet<Vector2Int> makeroomend(HashSet<Vector2Int> wholefloor, HashSet<Vector2Int> Platforms)
    {
        BoundsInt startbounds = new BoundsInt(new Vector3Int(150, 0, 0), new Vector3Int(40, 150, 0));
        BoundsInt startroombounds = new BoundsInt(new Vector3Int(161, 57, 0), new Vector3Int(20, 14, 0));
